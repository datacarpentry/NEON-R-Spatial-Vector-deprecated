...
describe the data.
For example, a line shapefile that contains the locations of streams, might 
contain stream
names for each line.
...
Finally we see there is one variable named "id" that appears to consists of only 
ones (min and max value both 1).
...
#Viewing Specific Shapefile Attributes
