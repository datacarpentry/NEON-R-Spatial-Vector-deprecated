...
and information about the coordinate reference including that the coordinates 
are UTMs from zone 18.  This helps us interpret the previous line giving the
extent of the file.  Finally we see there is one variable named "id" that 
appears to consists of only ones (min and max value both 1).
