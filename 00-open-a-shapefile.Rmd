...
* a point shapefile representing the location of a [flux tower](http://www.neoninc.org/science-design/collection-methods/flux-tower-measurements) 
...
giving the extent of the file.  We will discuss attributes in more detail a bit 
later. Finally we see there is one variable named "id" that appears to consists 
of only ones (min and max value both 1).
...
We can also view the just CRS or Extent for the shapefile using the 
following commands:
