...
Bonus:  Curious about what the OGR is in `readOGR()`?  Well, OGR was originally 
named for OpenGIS Simple Features Reference Implementation, however, it is not 
fully compatable with OpenGIS Simple Features so the name is now simple OGR with
the basis of the name being purely historical.  Want more?  Check out the GDAL 
wiki <a href="https://trac.osgeo.org/gdal/wiki/FAQGeneral" target="_blank">
GDAL wiki FAQ</a>.
