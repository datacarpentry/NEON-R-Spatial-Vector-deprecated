...
#Read the .csv file
plot.locations_HARV <- read.csv("NEON-DS-Site-Layout-Files-HARV/HARV/HARV_PlotLocations.csv")
...
chm_HARV <- raster("NEON-DS-Airborne-RemoteSensing-HARV-SJER/HARV/CHM/HARV_chmCrop.tif")
