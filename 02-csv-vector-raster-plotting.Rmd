...
The `HARV_PlotLocations.csv` file contains x,y locations for some plots that are sampled by (NEON)[http://www.neoninc.org] field crews for vegetation and other 
...
```{r write-shapefile, results="hide" }
#write a shapefile
