...
Look back at the first figure in this lesson showing the relative extents of
all the spatial objects. Notice that the veg. plot extent (black) extends
slightly farther west than the CHM raster (green) extent. We cropped the raster
to the vector extent, but there isn't any raster data in that western region of
our plot area so the vegetation plot in that area appears outside the extent of
the raster data.
