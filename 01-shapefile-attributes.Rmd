...
Download the shapefiles needes to complete this lesson:
...
If you completed Lesson 00 you can skip this code chunk.
...
is an individual `Attribute` that describes an object. Shapefile _attributes_ 
