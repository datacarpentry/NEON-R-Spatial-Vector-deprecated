...
Note: We'll cover how to choose the color in the next section.
...
If our data is read in not as a factor, we can convert the categorical 
attribute values using `as.factor()`. Note: If your data is already a factor, 
