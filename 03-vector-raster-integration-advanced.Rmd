...
plot(squarePlot, main = "Cropped raster")
...
extent <- extent(xmin = 732161.2, xmax = 732238.7, ymin = 4713249, ymax = 4713333)
```

```{r Crop by drawn extent}
r_cropped_man <- crop(x = r, y = extent)

plot(squarePlot, main = "Manually cropped raster")
